...
public class formbeli extends javax.swing.JFrame {
   ...
   public final void loadData() {
        ...
        try {
            ...
            while (r.next()) {
                ...
                o[1] = r.getString("kd_buku");
                o[2] = r.getString("nama_buku");
    ...
    private void tampilpilih() {
        try {
            ...
            String sql = "SELECT nama_buku FROM tbl_barang WHERE jumlah_buku !='0'";
            ResultSet r = s.executeQuery(sql);

            while (r.next()) {
                pilihbuku.addItem(r.getString("nama_buku"));
            }
  ...
  private void nofaktur() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(kdbuku, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 80, 120, 30));
        ...
        jPanel1.add(tjumlah, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 180, 130, 30));
        ...
        jPanel1.add(hsatuan, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 120, 120, 30));
        ...
        jPanel1.add(ttotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 140, 120, 30));
        ...
        jPanel1.add(hitung, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 140, 100, 30));
        ...
        jPanel1.add(tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 330, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, 710, 120));
        ...
        jLabel5.setText("Penjualan Buku Cerita");
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 380, -1, -1));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 80, 100, 40));
        ...
        setSize(new java.awt.Dimension(977, 602));
    ...
    private void pilihbukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihbukuActionPerformed
        // TODO add your handling code here:
         if (pilihbuku.getSelectedItem().equals("pilih buku")){
            kdbuku.setText("");
            hsatuan.setText("");
        }else{
        try {
            ...
            String sql = "SELECT kd_buku, jumlah_buku FROM tbl_barang WHERE nama_buku ='" + pilihbuku.getSelectedItem() + "'";
            ResultSet r = s.executeQuery(sql);

            while (r.next()) {
                
                kdbuku.setText(r.getString("kd_buku"));
                jumlah.setText(r.getString("jumlah_buku"));
            }
        ...
        try {
            ...
            String sql = "SELECT harga_jual FROM tbl_barang WHERE nama_buku ='" + pilihbuku.getSelectedItem() + "'";
            ResultSet r = s.executeQuery(sql);
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if(faktur.getText().equals("") ||kdbuku.getText().equals("") || pilihbuku.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")|| ttotal.getText().equals("")){
            ...
            String kdbukuu = kdbuku.getText();
            String pilihbukuu = (String)pilihbuku.getSelectedItem();
            ...
            try {
                ...
                try (PreparedStatement p = c.prepareStatement(sql)) {
                    p.setString(1, null);
                    p.setString(2, kdbukuu);
                    p.setString(3, pilihbukuu);
